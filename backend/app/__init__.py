...
def create_app():
    ...
    # 注册蓝图
    from app.routes import auth_bp, quotation_bp, module_bp, material_bp, fee_bp, version_bp, user_bp, export_bp, logs_bp, roles_bp, fee_rate_bp, exchange_rate_bp, module_participant_bp, sync_bp, change_request_bp, messages_bp
