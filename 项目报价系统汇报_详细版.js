...
// 左侧橙色竖条装饰
slide1.addShape(pres.shapes.RECTANGLE, {
  x: 0, y: 1.3, w: 0.15, h: 5.8,
  fill: { color: COLORS.orange }
});

// 副标题
slide1.addText("开发计划与模块设计", {
  x: 0.5, y: 1.8, w: 12.3, h: 0.6,
...
// 分隔线
slide1.addShape(pres.shapes.RECTANGLE, {
  x: 4.5, y: 2.6, w: 4.3, h: 0.05,
  fill: { color: COLORS.orange }
});

// 汇报信息
slide1.addText("ALL---项目报价系统", {
...
// 底部装饰
slide1.addShape(pres.shapes.RECTANGLE, {
  x: 10, y: 6.8, w: 3, h: 0.08,
  fill: { color: COLORS.orange }
});

// 页码
slide1.addText("1", {
  x: 0.3, y: 6.8, w: 0.5, h: 0.4,
...
const tocItems = [
  ...
  { num: "03", title: "技术架构设计" },
  { num: "04", title: "数据模型设计" },
  { num: "05", title: "核心模块详细设计" },
  { num: "06", title: "开发计划与里程碑" },
  { num: "07", title: "预期成果" }
];
...
slide3.addText("ALL---项目报价系统---项目背景与目标", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
...
slide4.addText("ALL---项目报价系统---系统功能规划", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
modules.forEach((mod, i) => {
  ...
  // 标题
  slide4.addText(mod.icon + " " + mod.title, {
...
slide5.addText("ALL---项目报价系统---核心业务流程", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide6.addText("ALL---项目报价系统---技术架构设计", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide7.addText("ALL---项目报价系统---数据模型设计", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide7.addText("数据模型清单（共 17 个模型）", {
...
slide8.addText("ALL---项目报价系统---核心模块详细设计", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide9.addText("ALL---项目报价系统---API 接口设计", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide9.addText("主要 API 模块（共 17 个接口文件）", {
...
slide10.addText("ALL---项目报价系统---开发计划与里程碑", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide10.addText("预计总工期：10周  |  团队规模：3-4人  |  目标：完成 P0 所有功能并上线", {
  x: 0.5, y: 5.7, w: 12.3, h: 0.4,
  fontSize: 13, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, align: "center"
});
slide10.addText("P0：报价单管理 | 物料管理 | 模块管理 | 费用管理 | 版本控制 | 变更申请 | 权限管理", {
...
slide11.addText("ALL---项目报价系统---预期成果", {
  x: 0.5, y: 0.2, w: 12.3, h: 0.6,
  fontSize: 24, fontFace: "Microsoft YaHei", bold: true,
  color: COLORS.white, margin: 0
});
...
slide12.addText("项目报价系统开发计划与模块设计", {
...
// 保存文件
pres.writeFile({ fileName: "/mnt/c/Users/rs8568/Desktop/Project/项目报价系统汇报_详细版.pptx" })
